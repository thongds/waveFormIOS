...
//        while signedByteArray.count > 0 {
//            
//            mMaxGain += 1
//            buffer = (file.readData(ofLength: 12))
//            signedByteArray = buffer.map { Int8(bitPattern: $0) } // [Int8]
//            print("length: \(mMaxGain) value: \(signedByteArray)")
//            
//            print(((buffer[10] & 0x01) << 7))
//            
//        }
...
//                }
            ...
            bufferSkip = file.readData(ofLength: frameLen - 12)
            pos += frameLen;
            offset = 0;
        }
...
//            
//            mMaxGain += 1
//            buffer = (file.readData(ofLength: 24))
////            buffer.removeSubrange(8...11)
////            bufferSkip = (file.readData(ofLength: 4))
////            buffer.append(bufferSkip)
//            signedByteArray = buffer.map { Int8(bitPattern: $0) } // [Int8]
//            print("length: \(mMaxGain) value: \(signedByteArray)")
//            for var i in 0...buffer.count{
//                print(buffer[i].hashValue)
//                
//            }
////            let a = (buffer[11] & 0xF0) >> 4
////            print(a)
////            print(a.hashValue)
//            
//        }
